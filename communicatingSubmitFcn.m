...
if verLessThan('matlab', '9.6') || ...
    ...
    if ~verLessThan('matlab', '25.1') %#ok<VERLESSMATLAB>
        ...
        error('parallelexamples:GenericPBS:SmpdNoLongerSupported', ...
...
jobName = strrep(jobName, 'MATLAB_R20', 'R');
maxJobNameLength = 15;
...
% Path to the submit script, to submit the PBS job using qsub
...
% Create the scripts to submit a PBS job.
